...
public class Autobus2 extends Thread {
    ...
    public Autobus2(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus2.png")));
        ...
        do {
            ...
            Ubicaciones.setBus2(coordX,coordY);
            // Revisa si el autobus se encuentra en la parada Ciudad Deportiva Rafael Ángel
            // Pérez
            if (coordX == 244 && coordY == 497) {
                parada();
                setMensaje("El autobus 2 se encuentra en la parada Ciudad Deportiva Rafael Ángel Pérez");
            }
            ...
            if (coordX == Ubicaciones.getBus10()[0] && coordY == Ubicaciones.getBus10()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
