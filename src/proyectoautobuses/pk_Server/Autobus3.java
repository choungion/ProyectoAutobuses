...
public class Autobus3 extends Thread {
    ...
    public Autobus3(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    private void parada() {
        ...
        System.out.println("Autobus 3: Suben "+ suben +", bajan "+ bajan);
        System.out.println("Autobus 3: Quedan " + pasajeros + " asientos libres.");
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus3.png")));
        ...
        do {
            ...
            Ubicaciones.setBus3(coordX,coordY);
            ...
            if (coordX == Ubicaciones.getBus2()[0] && coordY == Ubicaciones.getBus2()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
