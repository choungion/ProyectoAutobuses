...
public class Autobus4 extends Thread {
    ...
    public Autobus4(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus4.png")));
        ...
        do {
            ...
            if (coordX == Ubicaciones.getBus3()[0] && coordY == Ubicaciones.getBus3()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
