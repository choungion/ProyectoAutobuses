...
public class Autobus5 extends Thread {
    ...
    // Este metodo le da valores a las valiables nombre y label
    public Autobus5(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    private void parada() {
        ...
        System.out.println("Autobus 5: Suben "+ suben +", bajan "+ bajan);
        System.out.println("Autobus 5: Quedan " + pasajeros + " asientos libres.");
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus5.png")));
        ...
        do {
            ...
            Ubicaciones.setBus5(coordX,coordY);
            ...
            if (coordX == Ubicaciones.getBus4()[0] && coordY == Ubicaciones.getBus4()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
