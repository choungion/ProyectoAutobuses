...
public class Autobus7 extends Thread {
    ...
    public Autobus7(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    private void parada() {
        ...
        System.out.println("Autobus 7: Suben "+ suben +", bajan "+ bajan);
        System.out.println("Autobus 7: Quedan " + pasajeros + " asientos libres.");
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus7.png")));
        ...
        do {
            ...
            Ubicaciones.setBus7(coordX,coordY);
            ...
            if (coordX == Ubicaciones.getBus6()[0] && coordY == Ubicaciones.getBus6()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
