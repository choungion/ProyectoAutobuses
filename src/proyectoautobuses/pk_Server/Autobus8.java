...
public class Autobus8 extends Thread {
    ...
    // este metodo le da valores a las variables nombre y label
    public Autobus8(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    private void parada() {
        ...
        System.out.println("Autobus 8: Suben "+ suben +", bajan "+ bajan);
        System.out.println("Autobus 8: Quedan " + pasajeros + " asientos libres.");
    ...
    // Este metodo determina el comportamiento del hilo
    public void run() {
        // Se le agrea una imagen al label
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus8.png")));
        ...
        do {
            ...
            Ubicaciones.setBus8(coordX,coordY);
            ...
            if (coordX == Ubicaciones.getBus7()[0] && coordY == Ubicaciones.getBus7()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
