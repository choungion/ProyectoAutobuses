...
public class Autobus9 extends Thread {
    ...
    public Autobus9(String nombre, JLabel label) {
        this.nombre = nombre;
        this.label = label;
    }
    ...
    private void parada() {
        ...
        System.out.println("Autobus 9:Suben "+ suben +", bajan "+ bajan);
        System.out.println("Autobus 9: Quedan " + pasajeros + " asientos libres.");
    ...
    public void run() {
        ...
        label.setIcon(new ImageIcon(getClass().getResource("Imagenes//Autobus9.png")));
        ...
        do {
            ...
            Ubicaciones.setBus9(coordX,coordY);
            ...
            if (coordX == Ubicaciones.getBus8()[0] && coordY == Ubicaciones.getBus8()[1]) {
                try {
                    Thread.sleep(600);
                } catch (InterruptedException e1) {
                    e1.printStackTrace();
